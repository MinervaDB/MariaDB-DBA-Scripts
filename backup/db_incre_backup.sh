...
incremental_backup() {
        ...
        BACKUP_NAME=${JOB_TIMESTAMP}_incre_backup

        # print recent backup name
        echo "Basedir=${LAST_BACKUP}"
...
echo "=============================================="
echo "== SERVICEDB DB Incremental Backup"
echo "=============================================="
...
# execute real increamental backup
incremental_backup
